...
class BlogExtractSpider(scrapy.Spider):
    ...
    allowed_domains = ["eofire.com","disqus.com"]
    start_urls = ['https://www.eofire.com/blog/']
    ...
    def parse(self, response):
        ...
        for sub_blog in  blog_posts:
            ...
            #Get Title, Link, Date
            title = sub_blog.xpath('header/h2[@class="entry-title"]/a/text()').extract_first().strip()
    ...
    def parse_sub_blog(self, response):
        ...
        author =  response.xpath('//meta[@property="article:author"]/@content').extract_first()
...
def get_comments_url(link, title, post_id):
    ...
    params =  {
        "base": "default",
        "f": "entrepreneuronfire",
        "t_u": link,
        "t_i": "%s https://www.eofire.com/?p=%s" % (post_id, post_id),
        "t_e": title,
        "t_d": title,
        "t_t": title,
        "s_o": "default"
