...
class BlogExtractSpider(scrapy.Spider):
    ...
    quotes_base_url = "https://medium.com/_/api/users/c2146664c8e4/profile/stream?limit=8&to=%s&source=overview&page=%s"
    ...
    def parse(self, response):
        ...
        if '1392392497907' in response.url:
            print 'data is ', posts
        for post in posts.values():
            ...
            if post['uniqueSlug']:
                item['link'] = "https://medium.com/@rrhoover/" + post['uniqueSlug']
            else:
                item['link'] = "https://medium.com/@rrhoover/" + post['slug'] + '-' + post['id']
        ...
        if _next_page:
            ...
            yield scrapy.Request(self.quotes_base_url % (_to, _page_num), dont_filter= True)
    ...
    def parse_sub_blog(self, response):
        ...
        if not header.xpath('//a[@data-user-id="c2146664c8e4"]'):
            return

        item['author'] = header.xpath('//a[@data-user-id="c2146664c8e4"]/text()').extract()[0]
