...
class BlogExtractSpider(scrapy.Spider):
    ...
    allowed_domains = ["niashanks.com"]
    start_urls = ['http://www.niashanks.com/blog/']
    ...
    def parse(self, response):
        ...
        for sub_blog in blogs:
            ...
            author = sub_blog.xpath('p[@class="entry-meta"]/span[@class="entry-author"]/a/span/text()').extract_first().strip()
    ...
    def parse_sub_blog(self, response):
        ...
        continue_tags = ["rm-player"]
        end_tag = ["share-after share-filled share-small"]
        word_count = 0
