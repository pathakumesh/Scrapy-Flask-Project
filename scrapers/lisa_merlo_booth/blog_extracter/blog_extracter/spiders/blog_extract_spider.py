...
class BlogExtractSpider(scrapy.Spider):
    ...
    allowed_domains = ["lisamerlobooth.com"]
    start_urls = ['https://lisamerlobooth.com/blog/']
    ...
    def parse(self, response):
        ...
        for sub_blog in  blog_posts.xpath('article[contains(@class, "post-")]'):
            ...
            author = sub_blog.xpath('header/p[@class="entry-meta"]/span[@class="entry-author"]/a/span/text()').extract_first().strip()
    ...
    def parse_sub_blog(self, response):
        ...
        ignore_blocks = ["the_champ_sharing_container the_champ_horizontal_sharing"]
        word_count = 0
