...
class BlogExtractSpider(scrapy.Spider):
    ...
    allowed_domains = ["moneyboss.com"]
    start_urls = ['http://moneyboss.com/']
    ...
    def parse(self, response):
        ...
        for sub_blog in blogs:
            ...
            date = sub_blog.xpath('p[@class="entry-meta"]//time[@itemprop="datePublished"]/text()').extract_first()
            author =sub_blog.xpath('p[@class="entry-meta"]//span[@class="entry-author-name"]/text()').extract_first()
    ...
    def parse_sub_blog(self, response):
        ...
        start_tag = ["money-before-content"]
        end_tag = ["money-after-content"]
        word_count = 0
